PS C:\Users\roman\Documents\apppklod\permacalendarv2> flutter devices
Found 4 connected devices:
  ...
  Chrome (web)      • chrome      • web-javascript • Google Chrome 142.0.7444.61
...
warning - The value of the field '_initialSizeForScale' isn't used - lib\shared\widgets\organic_dashboard.dart:42:11 -
   ...
   info - Parameter 'key' could be a super parameter - lib\shared\widgets\organic_dashboard.dart:370:9 -
          use_super_parameters
  error - The class '_CalibratableHotspotState' doesn't have an unnamed constructor -
         lib\shared\widgets\organic_dashboard.dart:390:48 - new_with_undefined_constructor_default
  error - Missing concrete implementation of 'abstract class State<T extends StatefulWidget> with Diagnosticable.build'
         - lib\shared\widgets\organic_dashboard.dart:393:7 - non_abstract_class_inherits_abstract_member
  error - Undefined name 'box' - lib\shared\widgets\organic_dashboard.dart:396:18 - undefined_identifier
  error - Undefined name 'local' - lib\shared\widgets\organic_dashboard.dart:398:8 - undefined_identifier
  error - The instance member 'size' can't be accessed in an initializer -
         lib\shared\widgets\organic_dashboard.dart:398:19 - implicit_this_reference_in_initializer
  error - Undefined name 'local' - lib\shared\widgets\organic_dashboard.dart:399:8 - undefined_identifier
  error - The instance member 'size' can't be accessed in an initializer -
         lib\shared\widgets\organic_dashboard.dart:399:19 - implicit_this_reference_in_initializer
  error - 'debugPrint' must have a method body because '_CalibratableHotspotState' isn't abstract -
         lib\shared\widgets\organic_dashboard.dart:401:5 - concrete_class_with_abstract_member
  error - Expected an identifier - lib\shared\widgets\organic_dashboard.dart:401:16 - missing_identifier
  error - Expected to find ')' - lib\shared\widgets\organic_dashboard.dart:401:55 - expected_token
  error - Methods must have an explicit list of parameters - lib\shared\widgets\organic_dashboard.dart:402:5 -
         missing_method_parameters
  error - The name of a constructor must match the name of the enclosing class -
         lib\shared\widgets\organic_dashboard.dart:402:5 - invalid_constructor_name
warning - The declaration '_CalibratableHotspotState.ref' isn't referenced -
       lib\shared\widgets\organic_dashboard.dart:402:12 - unused_element
   info - Empty constructor bodies should be written using a ';' rather than '{}' -
          lib\shared\widgets\organic_dashboard.dart:402:15 - empty_constructor_bodies
  error - A function body must be provided - lib\shared\widgets\organic_dashboard.dart:402:15 - missing_function_body
  error - Expected a class member - lib\shared\widgets\organic_dashboard.dart:402:15 - expected_class_member
  error - The prefix 'organicZonesProvider' can't be used here because it's shadowed by a local declaration -
         lib\shared\widgets\organic_dashboard.dart:402:21 - prefix_shadowed_by_local_declaration
  error - Expected an identifier - lib\shared\widgets\organic_dashboard.dart:402:50 - missing_identifier
  error - A function body must be provided - lib\shared\widgets\organic_dashboard.dart:402:51 - missing_function_body
  error - Expected a class member - lib\shared\widgets\organic_dashboard.dart:402:51 - expected_class_member
  error - 'setPosition' must have a method body because '_CalibratableHotspotState' isn't abstract -
         lib\shared\widgets\organic_dashboard.dart:402:52 - concrete_class_with_abstract_member
  error - Undefined class 'id' - lib\shared\widgets\organic_dashboard.dart:402:64 - undefined_class
  error - Expected an identifier - lib\shared\widgets\organic_dashboard.dart:402:73 - missing_identifier
  error - Methods must have an explicit list of parameters - lib\shared\widgets\organic_dashboard.dart:403:5 -
         missing_method_parameters
  error - The name of a constructor must match the name of the enclosing class -
         lib\shared\widgets\organic_dashboard.dart:403:5 - invalid_constructor_name
warning - The declaration '_CalibratableHotspotState.ref' isn't referenced -
       lib\shared\widgets\organic_dashboard.dart:403:12 - unused_element
   info - Empty constructor bodies should be written using a ';' rather than '{}' -
          lib\shared\widgets\organic_dashboard.dart:403:15 - empty_constructor_bodies
  error - A function body must be provided - lib\shared\widgets\organic_dashboard.dart:403:15 - missing_function_body
  error - Expected a class member - lib\shared\widgets\organic_dashboard.dart:403:15 - expected_class_member
  error - The name 'read' is already defined - lib\shared\widgets\organic_dashboard.dart:403:16 - duplicate_definition
  error - The prefix 'calibrationStateProvider' can't be used here because it's shadowed by a local declaration -
         lib\shared\widgets\organic_dashboard.dart:403:21 - prefix_shadowed_by_local_declaration
  error - Expected an identifier - lib\shared\widgets\organic_dashboard.dart:403:54 - missing_identifier
  error - A function body must be provided - lib\shared\widgets\organic_dashboard.dart:403:55 - missing_function_body
  error - Expected a class member - lib\shared\widgets\organic_dashboard.dart:403:55 - expected_class_member
  error - 'markAsModified' must have a method body because '_CalibratableHotspotState' isn't abstract -
         lib\shared\widgets\organic_dashboard.dart:403:56 - concrete_class_with_abstract_member
  error - Undefined name '_startSize' - lib\shared\widgets\organic_dashboard.dart:407:5 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:407:18 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:408:58 - undefined_identifier
  error - Undefined name '_startSize' - lib\shared\widgets\organic_dashboard.dart:408:80 - undefined_identifier
  error - Undefined name '_startSize' - lib\shared\widgets\organic_dashboard.dart:410:9 - undefined_identifier
  error - Undefined name '_startSize' - lib\shared\widgets\organic_dashboard.dart:411:22 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:412:59 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:413:5 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:413:60 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:417:17 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:425:61 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:426:7 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:426:66 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:429:5 - undefined_identifier
  error - Undefined name '_startSize' - lib\shared\widgets\organic_dashboard.dart:433:5 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:434:56 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:439:9 - undefined_identifier
   info - 'withOpacity' is deprecated and shouldn't be used. Use .withValues() to avoid precision loss -
          lib\shared\widgets\organic_dashboard.dart:447:32 - deprecated_member_use
   info - 'withOpacity' is deprecated and shouldn't be used. Use .withValues() to avoid precision loss -
          lib\shared\widgets\organic_dashboard.dart:448:51 - deprecated_member_use
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:453:15 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:464:84 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:464:101 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:465:13 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:465:53 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:467:22 - undefined_identifier
  error - Undefined name 'widget' - lib\shared\widgets\organic_dashboard.dart:468:25 - undefined_identifier
  error - Expected a method, getter, setter or operator declaration - lib\shared\widgets\organic_dashboard.dart:471:1 -
         expected_executable
   info - 'withOpacity' is deprecated and shouldn't be used. Use .withValues() to avoid precision loss -
...
1684 issues found. (ran in 135.0s)
