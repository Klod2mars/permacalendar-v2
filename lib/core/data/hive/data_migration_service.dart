...
class DataMigrationService {
  ...
  /// Public helper: crée une sauvegarde du dossier Hive et retourne le chemin de la sauvegarde.
  /// Retourne null s'il n'y avait rien à sauvegarder ou en cas d'échec.
  static Future<String?> createBackup() async {
    try {
      ...
      if (await hiveDir.exists()) {
        ...
        print('⚠️ Aucun dossier hive trouvé à sauvegarder');
        return null;
      }
    } catch (e) {
