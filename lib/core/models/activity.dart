...
class Activity extends HiveObject {
  ...
  /// Factory constructor pour une tâche personnalisée
  factory Activity.customTask({
    required String title,
    required String description,
    required String taskKind,
    String? zoneGardenBedId,
    bool urgent = false,
    ...
    return Activity(
      ...
      entityId: zoneGardenBedId,
      entityType: zoneGardenBedId != null ? EntityType.gardenBed : null,
      metadata: {
        'isCustomTask': true,
        'taskKind': taskKind,
        'urgent': urgent,
        if (recurrence != null) 'recurrence': recurrence,
        if (nextRunDate != null) 'nextRunDate': nextRunDate.toIso8601String(),
        if (zoneGardenBedId != null) 'zoneGardenBedId': zoneGardenBedId,
        ...?metadata,
      },
    );
  }
