...
class DashboardSlotsRepository {
  ...
  /// Supprime toutes les associations liées à un jardin spécifique
  static Future<void> removeGardenId(String gardenId) async {
    final box = await _ensureBox();
    
    // Parcourir toutes les clés pour trouver celles qui pointent vers ce jardin
