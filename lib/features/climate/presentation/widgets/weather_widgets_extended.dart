...
class _HourlyCurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final textStyleTemp = const TextStyle(
    ...
    for (int i = 0; i < data.length; i++) {
      ...
      final tpTemp = TextPainter(
          text: TextSpan(text: tempStr, style: textStyleTemp),
            ...
            child: Row(
              children: [
                ...
                SvgPicture.asset(
                  ...
                  placeholderBuilder: (_) => const Icon(Icons.wb_sunny,
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    const Text('km/h',
                        style: TextStyle(
                            color: Colors.white70, fontSize: 10, height: 1)),
                  ],
                )
              ],
            ),
...
class _CompassPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    void drawLabel(String text, double angle) {
      final r = radius - 15;
      final x = center.dx +
          r * math.cos(angle - math.pi / 2); // -pi/2 to start at top
    ...
    // Draw Arrow
    final angleRad = (degrees - 90) *
        (math.pi / 180); // Adjust so 0 is North (usual math 0 is East)
...
class _GaugePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(Rect.fromCircle(center: center, radius: radius), math.pi,
        (angle - math.pi), false, paintActive);
  }
...
class _SunPathPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
        Offset(size.width * 0.35, size.height * 0.3), 8, sunPaint);
    ...
    final horizonPaint = Paint()
      ...
      ..strokeWidth = 1;
    canvas.drawLine(
        Offset(0, size.height), Offset(size.width, size.height), horizonPaint);
  }
