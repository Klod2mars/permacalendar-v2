...
class WeatherViewData {
  ...
  factory WeatherViewData.fromUI({
    ...
    return WeatherViewData(
      locationLabel: coords.resolvedName ?? 'Unknown',
      coordinates: coords,
  ...
  @override
  String toString() {
    return 'WeatherViewData(locationLabel: $locationLabel, coordinates: $coordinates, result: $result, temperature: $temperature, minTemp: $minTemp, maxTemp: $maxTemp, icon: $icon, description: $description, timestamp: $timestamp, condition: $condition, weatherCode: $weatherCode, errorMessage: $errorMessage)';
  }
