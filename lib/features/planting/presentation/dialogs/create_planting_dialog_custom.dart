// lib/features/planting/presentation/dialogs/create_planting_dialog_custom.dart
...
class CreatePlantingDialogCustom extends ConsumerStatefulWidget {
  ...
  const CreatePlantingDialogCustom({
    super.key,
  ...
  @override
  ConsumerState<CreatePlantingDialogCustom> createState() =>
      _CreatePlantingDialogCustomState();
}

class _CreatePlantingDialogCustomState
    extends ConsumerState<CreatePlantingDialogCustom> {
  ...
  Widget build(BuildContext context) {
    ...
    // sizing for dialog — do not subtract keyboardInset here
    final double dialogMaxHeight = mq.size.height * 0.9;
    final double dialogWidth = mq.size.width * 0.92;
    final double constrainedHeight = dialogMaxHeight - 24.0;

    // We return a centered Material card so we avoid AlertDialog's IntrinsicWidth.
    return Center(
      child: Material(
        elevation: 24,
        ...
        child: ConstrainedBox(
          ...
          child: Padding(
            ...
            child: Column(
              // With ConstrainedBox(maxHeight: ...) this Column is bounded and Expanded works.
              ...
              children: [
                ...
                // Form area (fillable and scrollable, keyboard inset applied here ONLY)
                Expanded(
                ...
                // Actions row (kept outside scrollable to remain visible)
                const SizedBox(height: 8),
                Row(
  ...
  // --------------------
  // UI BUILDERS (no IntrinsicWidth anywhere)
  // --------------------
  Widget _buildActionBlock(ThemeData theme) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Wrap so items can break to next line
          Wrap(
            spacing: 8,
            runSpacing: 8,
            ...
            children: [
              ConstrainedBox(
                ...
                // FittedBox avoids forcing intrinsic measurements
                child: FittedBox(
