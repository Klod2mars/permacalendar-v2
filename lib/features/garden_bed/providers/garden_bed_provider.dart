...
final gardenBedNotifierProvider = NotifierProvider<GardenBedNotifier, GardenBedState>(
...
@Deprecated('Use gardenBedsForGardenProvider from garden_bed_scoped_provider.dart')
