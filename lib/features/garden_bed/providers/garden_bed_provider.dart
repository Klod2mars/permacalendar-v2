...
class GardenBedNotifier extends Notifier<GardenBedState> {
  ...
  Future<bool> createGardenBed(GardenBed gardenBed) async {
    ...
    try {
      ...
      // Invalider le provider scopté
      ref.invalidate(gardenBedsForGardenProvider(gardenBed.gardenId));
...
final gardenBedNotifierProvider =
    NotifierProvider<GardenBedNotifier, GardenBedState>(
  GardenBedNotifier.new,
);

// Deprecated alias for backward compatibility
@Deprecated('Use gardenBedNotifierProvider')
final gardenBedProvider = gardenBedNotifierProvider;
...
// DEPRECATED: Use gardenBedsForGardenProvider instead
// Reimplemented to pivot to the canonical source of truth to avoid stale state
@Deprecated(
    'Use gardenBedsForGardenProvider from garden_bed_scoped_provider.dart')
