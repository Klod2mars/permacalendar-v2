    ...
    if (gardenState.error != null) {
      return Scaffold(
        ...
        body: ErrorStateWidget(
          ...
          subtitle: 'Impossible de charger la liste des jardins : '
              '${gardenState.error}',
          onRetry: () =>
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: activeGardens.isEmpty
            ...
            : ListView.builder(
                itemCount: activeGardens.length +
                    (archivedCount > 0 ? 1 : 0),
                itemBuilder: (context, index) {
                  // Ligne spéciale pour signaler des jardins archivés
                  if (archivedCount > 0 &&
                      index == activeGardens.length) {
                    return Padding(
                  ...
                  return Padding(
                    ...
                    child: CustomCard(
                      child: ListTile(
                        ...
                        onTap: () => context.push(
                          AppRoutes.gardenDetail
                              .replaceFirst(':id', garden.id),
                        ),
                      ),
                    ),
                  );
