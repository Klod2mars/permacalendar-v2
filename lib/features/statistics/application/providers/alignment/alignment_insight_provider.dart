...
/// 4. Gère le cas spécial oÃ¹ aucune action n'est disponible
...
String _generateAlignmentMessage(
  ...
  switch (level) {
    case AlignmentLevel.excellent:
      return '$scoreInt% de tes actions sont parfaitement alignées avec le rythme naturel ! ðŸŒ±';
    case AlignmentLevel.good:
      return '$scoreInt% de tes actions respectent bien le calendrier naturel. Continue comme ça ! ðŸŒ¿';
    case AlignmentLevel.average:
      return '$scoreInt% de tes actions suivent le rythme naturel. Quelques ajustements pourraient t\'aider. ðŸŒ¾';
    case AlignmentLevel.poor:
      return '$scoreInt% de tes actions sont alignées. Consulte l\'Agenda Intelligent pour optimiser tes périodes. ðŸ“…';
    case AlignmentLevel.veryPoor:
      return '$scoreInt% de tes actions suivent le calendrier naturel. L\'Agenda Intelligent peut t\'aider à mieux planifier. ðŸ“š';
    case AlignmentLevel.noData:
      return 'Aucune action enregistrée pour le moment. Commence à planter et récolter pour voir ton alignement ! ðŸŒ±';
  }
}
...
final alignmentEncouragementMessageProvider =
  ...
  switch (insight.level) {
    case AlignmentLevel.excellent:
      return 'Tu maÃ®trises parfaitement le rythme naturel ! Un vrai jardinier permaculteur !';
    case AlignmentLevel.good:
