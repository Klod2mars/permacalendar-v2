        ...
        AspectRatio(
          ...
          child: LineChart(
            LineChartData(
              ...
              lineBarsData: [
                LineChartBarData(
                  spots: points.map((p) => FlSpot(p.month.toDouble(), p.score)).toList(),
                  isCurved: true,
                  color: primaryColor,
                  barWidth: 3,
                  ...
                  dotData: FlDotData(
                    show: true,
                    checkToShowDot: (spot, barData) => spot.y > 0, // Show dots only where there is data
                  ...
                  belowBarData: BarAreaData(
                    ...
                    gradient: LinearGradient(
                      colors: [primaryColor.withAlpha((0.3 * 255).toInt()), primaryColor.withAlpha(0)],
