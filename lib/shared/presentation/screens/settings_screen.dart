...
class SettingsScreen extends ConsumerWidget {
      ...
      CustomCard(
        child: Column(children: [
          ListTile(
            ...
            subtitle: const Text('Maximum ${AppConstants.maxGardensPerUser} jardins'),
      ...
      CustomCard(
        child: Column(children: [
          ...
          Builder(builder: (ctx) {
            ...
            final subtitle = selected == null ? 'Défaut: $defaultLabel' : 'Sélectionnée: $selected';
            return ListTile(
  ...
  void _showCommuneSelector(BuildContext context, WidgetRef ref) {
    showModalBottomSheet(
      ...
      builder: (modalCtx) {
        ...
        Future<void> performSearch(String q, void Function(void Function()) setState) async {
              ...
              Flexible(
                child: results.isEmpty
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (ctx, i) {
                          final p = results[i];
                          final subtitle = [p.admin1, p.country].where((s) => s.isNotEmpty).join(' • ');
                          return ListTile(
                            ...
                            onTap: () async {
                              ...
                              await ref.read(selectedCommuneProvider.notifier).setCommune(p.name);
                              ...
                              if (context.mounted) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text('Commune sélectionnée: ${p.name}')),
                                );
                              }
                            },
                          );
  ...
  void _showGardenLimitInfo(BuildContext context) {
    showDialog(
      ...
      builder: (context) => const InfoDialog(
        ...
        content: 'Cette version permet de gérer jusqu\'à ${AppConstants.maxGardensPerUser} jardins simultanément. '
  ...
  void _showHelp(BuildContext context) {
    showDialog(
      ...
      builder: (context) => const InfoDialog(
        title: 'Aide',
        content: 'PermaCalendar 2.0 vous aide à gérer vos jardins permaculturels.\n\n'
