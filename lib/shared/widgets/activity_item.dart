...
class ActivityItem extends StatelessWidget {
  ...
  /// Construit le sous-titre en combinant description et métadonnées
  String _buildSubtitle() {
    final parts = <String>[];

    // Ajouter des informations contextuelles selon le type d'activité
  ...
  /// Retourne l'icône appropriée pour le type d'activité
  ...
  /// Retourne la couleur appropriée pour le type d'activité
...
/// Widget pour afficher une liste d'activités avec un état vide
class ActivityList extends StatefulWidget {
  ...
  const ActivityList({
    ...
    this.compact = false,
    this.maxItems,
    this.emptyMessage = 'Aucune activité récente',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Commencez par créer votre premier jardin !',
        ...
        if (widget.enablePagination && _hasMoreItems() && !_isLoadingMore)
          Padding(
            ...
            child: TextButton.icon(
              ...
              label: const Text('Charger plus d\'activités'),
            ),
          ),
      ],
    );
