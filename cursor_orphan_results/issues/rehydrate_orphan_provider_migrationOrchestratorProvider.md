# [rehydrate] Provider orphelin: migrationOrchestratorProvider

- **Type**: provider (Riverpod)
- **Déclaration**: core\services\migration\migration_orchestrator.dart:914 【12†core\services\migration\migration_orchestrator.dart:914】
