...
void main() {
  ...
  testWidgets('CalendarViewScreen displays tasks and allows creation', (tester) async {
    ...
    // 5. Fill Form
    await tester.enterText(find.widgetWithText(TextFormField, 'Titre *'), 'New Created Task');
    ...
    await tester.tap(find.text(today).first); // Re-select to be sure or just check content
    await tester.pumpAndSettle();
