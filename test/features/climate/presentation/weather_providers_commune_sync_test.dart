...
void main() {
  ...
  group('Weather Providers Commune Sync', () {
    ...
    test('changing selected commune triggers weather refresh', () async {
      ...
      // Act 2: Changer la commune dans les settings
      await container.read(appSettingsProvider.notifier).setSelectedCommune('Lyon');
    ...
    test('selectedCommuneCoordinatesProvider uses selectedCommuneSettingsProvider',
      ...
      final initialCoordsAsync = container.read(selectedCommuneCoordinatesProvider);
      ...
      final updatedCoordsAsync = container.read(selectedCommuneCoordinatesProvider);
    ...
    test('forecastHistoryProvider uses selectedCommuneCoordinatesProvider', () async {
    ...
    test('null commune falls back to defaultCommuneName', () async {
      ...
      // Act: Réinitialiser la commune à null
      await container.read(appSettingsProvider.notifier).setSelectedCommune(null);
