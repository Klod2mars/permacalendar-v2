  ...
  group('Validators Tests', () {
    ...
    group('Description Validation', () {
      ...
      test('should reject null or empty descriptions when required', () {
        ...
        expect(
            Validators.validateDescription('   ', required: true), isNotNull);
      });
      ...
      test('should accept valid descriptions', () {
        ...
        expect(
            Validators.validateDescription(
                'Description avec des caractères spéciaux: éàç!'),
            isNull);
    ...
    group('Image URL Validation', () {
      ...
      test('should accept valid HTTP and HTTPS URLs', () {
        expect(Validators.validateImageUrl('http://example.com/image.jpg'),
            isNull);
        expect(Validators.validateImageUrl('https://example.com/image.png'),
            isNull);
        expect(
    ...
    group('Scientific Name Validation', () {
      ...
      test('should reject invalid formats', () {
        ...
        expect(Validators.validateScientificName('genus species'),
            isNotNull); // lowercase genus
        expect(Validators.validateScientificName('Genus Species'),
            isNotNull); // uppercase species
      });

      test('should accept valid scientific names', () {
        expect(
            Validators.validateScientificName('Solanum lycopersicum'), isNull);
        expect(Validators.validateScientificName('Brassica oleracea capitata'),
            isNull);
      });
    });
    ...
    group('Harvest Date Validation', () {
      ...
      test('should reject harvest dates before planting dates', () {
        ...
        expect(Validators.validateHarvestDate(plantingDate, harvestDate),
            isNotNull);
      });
      ...
      test('should accept valid harvest dates', () {
        ...
        expect(
            Validators.validateHarvestDate(plantingDate, harvestDate), isNull);
      });
    });
  });
}
