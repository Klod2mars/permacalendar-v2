...
void main() {
  ...
  group('GardenMigrationAdapters - V2 to Freezed', () {
    test('should convert Garden V2 to GardenFreezed', () {
      ...
      expect(
          gardenFreezed.updatedAt, DateTime(2024, 3, 15)); // Same as createdAt
      expect(
          gardenFreezed.totalAreaInSquareMeters, 0.0); // Will be recalculated
      expect(gardenFreezed.imageUrl, isNull);
      expect(
          gardenFreezed.metadata['gardenBedIds'], ['bed-1', 'bed-2', 'bed-3']);
  ...
  group('GardenMigrationAdapters - Hive to Freezed', () {
    ...
    test('should convert GardenFreezed back to GardenHive', () {
      ...
      // Act
      final gardenHive =
          GardenMigrationAdapters.toHive(gardenFreezed, gardenBeds: gardenBeds);
  ...
  group('GardenMigrationAdapters - Batch Migrations', () {
    test('should batch migrate legacy gardens', () {
      ...
      // Act
      final gardensFreezedu =
          GardenMigrationAdapters.batchMigrateLegacy(legacyGardens);
    ...
    test('should batch migrate Hive gardens', () {
      ...
      // Act
      final gardensFreezed =
          GardenMigrationAdapters.batchMigrateHive(gardensHive);
  ...
  group('GardenMigrationAdapters - Migration Stats', () {
    ...
    test('should provide stats for Legacy to Freezed migration', () {
      // Act
      final stats =
          GardenMigrationAdapters.getMigrationStats('legacy', 'freezed');
    ...
    test('should provide stats for Hive to Freezed migration', () {
      // Act
      final stats =
          GardenMigrationAdapters.getMigrationStats('hive', 'freezed');
  ...
  group('GardenMigrationAdapters - Data Integrity', () {
    test('should preserve all data in round-trip legacy -> freezed -> legacy',
      ...
      expect(
          roundTrip.totalAreaInSquareMeters, original.totalAreaInSquareMeters);
