...
void main() {
  group('ModernDataAdapter - Sanctuary Philosophy Validation', () {
    ...
    test('Scénario 4: Plantes inactives sont ignorées', () async {
      ...
      expect(
          plantIds, isNot(contains('lettuce'))); // Laitue inactive NOT included
    });
    ...
    test('Scénario 5: Isolation entre jardins (respect du Sanctuaire)',
        () async {
      ...
      expect(plantIds,
          isNot(contains('carrot'))); // Carotte de garden2 NOT included
    });
  });
}
