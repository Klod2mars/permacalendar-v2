  ...
  group('Plants JSON Validation', () {
    test('should validate required fields', () {
      ...
      for (final field in requiredFields) {
        expect(plant.containsKey(field), true,
            reason: 'Field "$field" is required');
        expect(plant[field], isNotNull,
            reason: 'Field "$field" cannot be null');
        expect(plant[field], isNotEmpty,
            reason: 'Field "$field" cannot be empty');
      }
    });
